...
import IMG3 from '../../assets/my ai.png'
      ...
      <div className="container portfolio__container">
        ...
        <article className="portfolio__item">
          <div className="portfolio__item-img">
            ...
            <a href="https://xscap.github.io/newclone/" className='btn' target = '_blank'>Live Demo</a>
            <a href="https://github.com/xscap/gem-clone" className='btn btn-primary' target='_blank'>Source Code</a>
